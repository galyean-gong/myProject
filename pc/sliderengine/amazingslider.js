...
(function($) {
	$.fn.ashtml5lightbox = function(options) {
		...
		inst.options = $.extend({
			...
			errorwidth: 280,
			errorheight: 48,
			errorcss: "text-align:center; color:#ff0000; font-size:1px; font-family:Arial, sans-serif;",
	...
	$.fn.amazingslider = function(options) {
				...
				if (this.options.versionmark != "AMC" + "om" && !(this.options.versionmark == "AML" + "ite" && this.options.skin && $.inArray(this.options.skin, ["classic", "cube", "content"]) >= 0)) {
					...
					if (item.text().indexOf(this.options.watermarktext) < 0 || mklink.length < 0) {
						...
						if (mklink.css("display") == "none" || mklink.css("visibility") == "hidden" || parseInt(mklink.css("font-size")) < 8 || mkdiv.css("display") == "none" || mkdiv.css("visibility") == "hidden" || parseInt(mkdiv.css("font-size")) < 8) {
							mklink.attr({
								style: (mklink.attr("style") || "") + "display:block!important;visibility:hidden!important;font-size:12px!important;"
							});
							mkdiv.attr({
								style: mkdiv.attr("style") + "display:block!important;visibility:hidden!important;font-size:12px!important;"
							})
						}
					}
				}
		...
		this.each(function() {
			...
			var defaultOptions = {
				...
				lightboxtitlebottomcss: "color:#333; font-size:1px; font-family:Armata,sans-serif,Arial; overflow:hidden; text-align:left;",
				...
				navthumbtitlecss: "display:block;position:relative;padding:2px 4px;text-align:left;font:bold 1px Arial,Helvetica,sans-serif;color:#333;",
			...
			var defaultTextOptions = {
				...
				// titlecss: "display:block; position:relative; font:bold 1px Inder,Arial,Tahoma,Helvetica,sans-serif; color:#fff;",
...
if (typeof amazingsliderId === "undefined") var amazingsliderId = 0; /** Amazing Slider - Responsive jQuery Slider and Image Scroller\n * Copyright 2015 Magic Hills Pty Ltd All Rights Reserved\n * Website: http://amazingslider.com\n * Version  \n */
(function($) {
	$.fn.asHTML5VideoControls = function(skinFolder, parentInst, hidecontrols, hideplaybutton, defaultvolume) {
		var isTouch = "ontouchstart" in window;
		var eStart = isTouch ? "touchstart" : "mousedown";
...
(function($) {
	$.fn.amazingslider = function(options) {
		...
		AmazingSlider.prototype = {
			...
			createMarkup: function() {
				this.$wrapper = jQuery("" + "<div class='amazingslider-wrapper-" + this.id + "'>" + "<div class='amazingslider-background-image-" + this.id + "'></div>" + "<div class='amazingslider-slider-" + this.id + "'>" +  "<div class='amazingslider-box-" + this.id + "'>" + "<div class='amazingslider-swipe-box-" + this.id + "'>" + "<div class='amazingslider-space-" + this.id + "'></div>" + "<div class='amazingslider-img-box-" + this.id + "'></div>" + "<div class='amazingslider-lightbox-play-" + this.id + "'></div>" + "<div class='amazingslider-timer-" + this.id + "'></div>" + "</div>" + "<div class='amazingslider-text-box-" + this.id + "'></div>" + "</div>" + "<div class='amazingslider-play-" + this.id + "'></div>" + "<div class='amazingslider-video-wrapper-" + this.id + "'></div>" + "<div class='amazingslider-ribbon-" + this.id + "'></div>" + "<div class='amazingslider-arrow-left-" + this.id + "'></div>" + "<div class='amazingslider-arrow-right-" + this.id + "'></div>" + "</div>" + "<div class='amazingslider-nav-" + this.id + "'><div class='amazingslider-nav-container-" + this.id + "'></div></div>" + "</div>");
				this.$wrapper.appendTo(this.container);
				$(".amazingslider-slider-" + this.id, this.container).data("sliderid", this.id);
				var instance = this;
				if (this.options.enabletouchswipe) $(".amazingslider-swipe-box-" + this.id, this.container).sliderTouchSwipe({
			...
			checkMK: function() {
				if (this.options.versionmark != "AMC" + "om" && !(this.options.versionmark == "AML" + "ite" && this.options.skin && $.inArray(this.options.skin, ["classic", "cube", "content"]) >= 0)) {
					...
					var mklink = $('a[href="' + this.options.watermarklink + '"]', item);
					if (item.text().indexOf(this.options.watermarktext) < 0 || mklink.length < 0) {
						var itemtext = '<div style="display:block !important;position:absolute;top:6px;left:6px;visibility:hidden !important;z-index:999999 !important;font:12px Arial,Tahoma,Helvetica,sans-serif;color:#666;padding:2px 4px;-webkit-border-radius:2px;-moz-border-radius:2px;border-radius:2px;background-color:#fff;opacity:0.9;filter:alpha(opacity=90);cursor:pointer;">' + '<a href="' + this.options.watermarklink + '" style="display:block!important;visibility:hidden!important;text-decoration:none;font:12px Arial,Tahoma,Helvetica,sans-serif;color:#333;" title="Responsive jQuery Slider" target="_blank">' + this.options.watermarktext + "</a>" + "</div>";
						item.append(itemtext)
					} else {
						var mkdiv = mklink.parent();
						if (mklink.css("display") == "none" || mklink.css("visibility") == "hidden" || parseInt(mklink.css("font-size")) < 8 || mkdiv.css("display") == "none" || mkdiv.css("visibility") == "hidden" || parseInt(mkdiv.css("font-size")) < 8) {
		...
		this.each(function() {
			...
			var defaultTextOptions = {
				...
				textcss: "display:block; padding:12px; text-align:left;",
				textbgcss: "display:block; position:absolute; top:0px; left:0px; width:100%; height:100%; background-color:#333333; opacity:0.6; filter:alpha(opacity=60);",
				titlecss: "display:none; position:relative; font:bold 1px Inder,Arial,Tahoma,Helvetica,sans-serif; color:#fff;",
				descriptioncss: "display:block; position:relative; font:12px Anaheim,Arial,Tahoma,Helvetica,sans-serif; color:#fff;",
				buttoncss: "display:block; position:relative;",
				texteffectresponsive: true,
				texteffectresponsivesize: 600,
